...
def validate_HD(generator,discriminator,HD_criterion):
    hash_distance_list = []
    hamming_dist_list = []
...
def train_gan(discriminator_args, generator_args, job_name,JSCC_checkpoint,DHD_checkpoint):
    ...
    while epoch < generator_args.JSCC_epoch and not generator_args.JSCC_resume:
        ...
        val_hash,val_hamming = validate_HD(generator,discriminator,HD_criterion)
...
if __name__ == '__main__':
    ...
    # job_name = 'Stage2_TRAINJSCC_with_FixedDHD_20dB_SNR_0709'
    ...
    # train_gan(args, args1, job_name,None,DHD_checkpoint)

    train_DHD = False
    job_name = 'Stage2_TRAINJSCC_with_Lpips_20dB_SNR_0709'
