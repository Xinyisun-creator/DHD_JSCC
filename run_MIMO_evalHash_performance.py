...
def plot_hash_distances_per_data_point(hash_distances1, hash_distances2, hash_distances3, file_path,mode):
    plt.figure(figsize=(12, 6))
    ...
    if mode == "hamming":
        plt.title('Hamming Distances for Each Data Point')
        plt.xlabel('Data Point Index')
...
if __name__ == '__main__':
    ...
    hash_dist1,hamming_dist1 = evaluate_gan(args, args1, job_name,evaluate_JSCC_path1,DHD_path)
    hash_dist2,hamming_dist2 = evaluate_gan(args, args1, job_name,evaluate_JSCC_path2,DHD_path)
    hash_dist3,hamming_dist3 = evaluate_gan(args, args1, job_name,evaluate_JSCC_path3,DHD_path)
    plot_hash_distances_per_data_point(hash_dist1, hash_dist2, hash_dist3, f'{timestamp}_test_with_ORG_DHD_HashDist.png',"hash")
    plot_hash_distances_per_data_point(hamming_dist1, hamming_dist2, hamming_dist3, f'{timestamp}_test_with_ORG_DHD_HammingDist.png',"hamming")
    ...
    hash_dist2,hamming_dist2 = evaluate_gan(args, args1, job_name,evaluate_JSCC_path2,DHD_path)
    hash_dist3,hamming_dist3 = evaluate_gan(args, args1, job_name,evaluate_JSCC_path3,DHD_path)
    plot_hash_distances_per_data_point(hash_dist1, hash_dist2, hash_dist3, f'{timestamp}_test_with_Stage3_DHD(bestmAP)_HashDist.png',"hash")
    plot_hash_distances_per_data_point(hamming_dist1, hamming_dist2, hamming_dist3, f'{timestamp}_test_with_Stage3(bestmAP)_DHD_HammingDist.png',"hamming")
